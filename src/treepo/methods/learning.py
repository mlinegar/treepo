...
:func:`treepo._research.ctreepo.alternating.run_alternating_family`.
...
layer. The audit lives at :func:`treepo.methods.dispatch.run` with
...
def _write_manifest(
    *,
    ...
    """Write the methods compatibility JSON sidecar for a run."""
    try:
