#!/usr/bin/env python3
"""Interim progress plots for publication C-TreePO CPU pass.

This script is designed for partial outputs while long runs are still in flight.
It creates lane-aware progress and learnability figures without requiring full completion.
"""
