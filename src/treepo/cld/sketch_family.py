"""FamilyRuntime wrapper for any ``treepo.sketches.protocol.SketchAdapter``.
...
:func:`treepo.cld.fit` just like learned families.
"""
...
from treepo.sketches.protocol import SketchAdapter
